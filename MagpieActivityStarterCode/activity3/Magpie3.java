...
public class Magpie3
{
	...
	public String getResponse(String statement)
	{
		...
		else if (findKeyword(statement, "Sachal") >= 0
				|| findKeyword(statement,"Kathy") >= 0)
				{
					response = "You just mentioned the coolest person I know.";
				}
		else if (findKeyword(statement,"Harvard") >= 0)
		{
		...
		else if (findKeyword(statement,"Mr. Sandler") >= 0
				|| findKeyword(statement,"Ms. Wong") >= 0
				|| findKeyword(statement,"Ms. Dunitz") >= 0
				|| findKeyword(statement,"Ms. Bernstein") >= 0
